...
Overall, math grades are left-skewed for Groups A, B, and C meaning there are much fewer As than Fs. Group D exhibits a left tail that is far less extreme than the first 3 groups. And Group E seems to almost have a perfectly uniform distribution of grades within the group.
